...
### ข้อ 4 — บันทึกผลการเยี่ยมบ้านลูกค้า

**Actor:** ช่าง หรือ Sale

**ข้อมูลที่บันทึก:**
| ฟิลด์ | รายละเอียด |
|:---|:---|
| ผลการเยี่ยม | สรุปสิ่งที่พบหน้างาน |
| ขนาดพื้นที่ (ถ้าสำรวจ) | กว้าง × ยาว × สูง |
| ความต้องการลูกค้า | บันทึกเพิ่มเติมจากการพูดคุย |
| ปัญหา/ข้อควรระวัง | จุดที่ต้องแจ้งทีมออกแบบ |
| รูปประกอบ | อ้างอิงรูปจากข้อ 2 |

---

### ข้อ 5 — บันทึกผลการออกแบบ (Design File)

**Actor:** Designer / Sale

**Functional Requirements:**
- อัปโหลดไฟล์ออกแบบได้หลายไฟล์ รองรับ: `.pdf`, `.jpg`, `.png`, `.dwg`, `.skp`
- รองรับ **หลายเวอร์ชัน** → แต่ละครั้งที่อัปโหลดใหม่ระบบเพิ่ม Version Number อัตโนมัติ
...
- ลิงก์ดาวน์โหลดมีอายุจำกัด (Pre-signed URL จาก Object Storage)

#### ข้อมูลที่บันทึก:
| ฟิลด์ | รายละเอียด |
|:---|:---|
| `version` | เลขเวอร์ชัน (v1, v2, v3...) |
| `file_name / file_type` | ชื่อไฟล์และประเภท |
| `file_size` | ขนาดไฟล์ |
...
**Functional Requirements:**
- สร้าง BOQ ต่อ 1 Job, รองรับหลายเวอร์ชัน
- เลือกรายการวัสดุ/ค่าแรงจาก Master Data หรือเพิ่มรายการเฉพาะกิจ
- ระบบ **คำนวณอัตโนมัติ:** ราคารวม → ส่วนลด → ภาษีมูลค่าเพิ่ม → ยอดสุทธิ
- **ตรึงราคา ณ เวลาที่เพิ่มรายการ** → การเปลี่ยน Master Price ในภายหลังไม่กระทบ BOQ เดิม
- ส่งออกเป็น PDF และ Excel
- แสดงต้นทุน/กำไรขั้นต้นเฉพาะบทบาทที่มีสิทธิ์
