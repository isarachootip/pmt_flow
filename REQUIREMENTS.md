...
Response: { "success": true, "data": { "job_id": 101, "job_no": "JOB26090900001", "status": "DRAFT" } }
```
...
- ระบบ **คำนวณอัตโนมัติแบบ Real-time:** ราคารวม (Subtotal) → ส่วนลดโครงการ (Discount) → ยอดสุทธิ (Grand Total / No VAT)
...
- ยอดสุทธิคำนวณจาก `Grand Total = Math.max(0, Subtotal - Discount)` (No VAT 7%)
