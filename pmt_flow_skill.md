...
## ⏰ 3. มาตรฐานการแสดงผลและบันทึกเวลา 24 ชั่วโมง (24-Hour Time Standard: Strictly NO AM/PM)

ระบบ **PMT Flow** กำหนดมาตรฐานเวลาสำหรับทุกหน้าจอและทุกฟอร์มบันทึกเวลาไว้อย่างเด็ดขาด:

### 3.1 รูปแบบเวลามาตรฐานบังคับ (Mandatory 24-Hour Clock)
...
## 🛠️ 4. ข้อกำหนดฟังก์ชันบันทึกงานช่างประจำวัน (Daily Technician Work Log Specification)
...
### 4.1 ขอบเขตหน้าจอและการเข้าถึง (Dual Views)
...
### 4.2 ข้อมูลที่ต้องบันทึกในแต่ละวัน
...
### 4.3 แผงแนบรูปถ่ายหน้างาน 5 รูป (5 Photo Slots) พร้อมระบบ Preview
...
### 4.4 การส่งมอบงานเข้าสู่ QC เมื่อช่างทำสำเร็จ 100%
...
## 🔄 5. ภาพรวมขอบเขต Flow งาน 5+2 ขั้นตอน (Pipeline Scope)
...
## 🛡️ 6. ข้อบังคับด้านความปลอดภัยและ Deployment
