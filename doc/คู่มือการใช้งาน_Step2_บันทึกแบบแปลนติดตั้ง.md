...
### Q3: สามารถเปิดดูแบบแปลน Drawing และประมาณการ BOQ ระหว่างตรวจสอบคิวงานใน Step 2 Ticket ได้หรือไม่?
> **คำตอบ:** ได้อย่างสมบูรณ์ เมื่อคลิกที่แถวงานหรือรหัส Job ID ในตารางคิวงาน Step 2 ระบบจะเปิดหน้าต่าง Pop up พรีวิวโครงการ (`modal-job-preview-detail`) ซึ่งจะแสดงทั้ง **Section แบบแปลนติดตั้ง & Drawing (Design & Blueprints CAD / 2D / 3D)** พร้อม Lightbox และ **Section ตารางประมาณการราคา BOQ** (โดยหากยังไม่มีการใส่รายการ จะแสดงสถานะ **Blank BOQ** สีม่วงชัดเจน ปราศจากรายการ Dummy รบกวน) ช่วยให้ทีมงานและ SA ตรวจสอบความถูกต้องของแบบแปลนและมูลค่าโครงการได้ทันที

### Q4: เมื่อบันทึกแบบแปลนเป็นเวอร์ชัน v2.0 Final แล้ว ทำไมปุ่ม "บันทึกแบบแปลน" จึงถูก Disable?
> **คำตอบ:** เป็นไปตามกฎความปลอดภัยของระบบ PMT Flow (Workflow State Integrity) เมื่อแบบแปลนได้รับการอนุมัติเป็น **`v2.0 Approved (Final Design)`** ถือว่าขั้นตอนงานออกแบบเสร็จสมบูรณ์ ระบบจะ **Active และปลดล็อคขั้นตอนที่ 3 (BOQ)** ให้เริ่มดำเนินการได้ทันที และทำการ **Disable (ล็อค) ปุ่มบันทึกแบบแปลน** และฟอร์มอัปโหลดใน Step 2 โดยอัตโนมัติ เพื่อป้องกันการอัปโหลดหรือแก้ไขแบบแปลนทับซ้อนในขณะที่กำลังจัดทำประมาณการราคา BOQ (หากต้องการแก้ไขแบบ จะต้องลบแบบ v2.0 Final เดิมออกก่อน ระบบจึงจะเปิดให้บันทึกแบบใหม่ได้)
