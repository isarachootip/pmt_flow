...
2. **จำนวนรูปถ่ายหน้างาน (Site Photos):** ใน `site_photos` ต้องมีรูปถ่าย **อย่างน้อย 5 รูป** (รูปถ่ายเพิ่มเติมและหลักฐานหน้างานสามารถถ่ายหรือ Add รูปเพิ่มเติมในระบบ PMT ได้อย่างอิสระ)
...
5. **ขอบเขตการทำงาน (PMT-Native Features):** 
   - **คำสั่งพิเศษ (Special Instructions) & ข้อมูลเพิ่มเติม (Additional Notes):** จัดการและบันทึกโดย **ทีม QC** ในฝั่ง PMT หลังจากที่มีการบันทึกข้อมูลตั้งต้นมาจากระบบ AE เพื่อความถูกต้องและแจ้งข้อกำหนดเฉพาะหน้างานให้ช่างทราบ
   - **การ Add รูปเพิ่มเติม (Additional Site Photos):** **ทีม QC และช่าง** สามารถถ่ายรูปและ Add รูปภาพหน้างานเพิ่มเติมได้โดยตรงผ่านระบบ PMT เพื่อกำกับคุณภาพและใช้เป็นหลักฐานการส่งมอบงาน
