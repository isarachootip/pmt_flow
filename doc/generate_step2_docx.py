...
def create_document():
    ...
    add_callout(
        ...
        text="1. ชี้ให้ผู้เรียนเห็น JOB26090900002 ซึ่งมีแบบแนบแล้ว 1 โซน ให้ทดลองคลิกปุ่ม 'ยืนยันย้ายไป Step 3' เพื่อดูหน้าต่างสรุป\n"
             "2. สำหรับ JOB26090900004 ที่ยังไม่มีแบบ ให้คลิก 'บันทึก Design' แล้วเลือกปุ่มตัวอย่างด่วน '[แบบครัว Built-in]' เพื่อแสดงความรวดเร็วในการทำงาน\n"
