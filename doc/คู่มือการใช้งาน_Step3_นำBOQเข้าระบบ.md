...
2. **โหมด Dedicated BOQ Workspace (หน้าจอ Step 3):** ทำหน้าที่เป็นศูนย์กลางคลังรายการ BOQ ของทุกโครงการ สำหรับฝ่ายประเมินราคาและ Cost Controller ในการ:
   - นำเข้ารายการวัสดุและค่าแรงจากไฟล์ภายนอก (Excel `.xlsx` / `.csv` / vFIX) โดยมีระบบคัดกรอง **นำเข้าเฉพาะหัวข้อที่ขึ้นต้นด้วย "'งาน" หรือ "งาน" เท่านั้น** เพื่อตัดวัสดุย่อยและแถวสรุปยอดออกโดยอัตโนมัติ
...
> **คำตอบ:** ไม่ส่งผลกระทบใดๆ ทั้งสิ้น ระบบทำงานภายใต้มาตรฐาน **Customer Name Protection Standard** โดยจะนำเข้าเฉพาะข้อมูลรายการทำงาน (รหัสสินค้า, รายการวัสดุ/บริการ, จำนวน, หน่วย, ค่าวัสดุ, ค่าแรง, ยอดรวม) เข้าสู่ Job เท่านั้น โดยไม่มีการจับคู่หรือเปลี่ยนชื่อลูกค้า เบอร์โทร หรือที่อยู่เดิมของโครงการ ข้อมูลหัวเอกสารจากไฟล์ภายนอกจะถูกจัดเก็บเป็นเพียง Reference Metadata เท่านั้น เพื่อความปลอดภัยของข้อมูลลูกค้าเดิม 100%
...
> **คำตอบ:** ข้อมูลราคาต่อหน่วยในไฟล์ Excel (ทั้งค่าวัสดุและค่าแรง) จะถูกนำไปคำนวณหาราคารวม (Subtotal), หักส่วนลดโครงการ (Discount) และคำนวณเป็น **"ยอดสุทธิ (Grand Total / No VAT)"** โดยอัตโนมัติ 100% ตามสูตร `Grand Total = Math.max(0, Subtotal - Discount)` โดยไม่มีการบวกภาษี VAT 7% ซ้ำซ้อน

### Q8: เงื่อนไขการคัดกรองรายการในใบเสนอราคา / BOQ ก่อนนำเข้าระบบมีอะไรบ้าง?
> **คำตอบ:** ระบบมีเงื่อนไขการคัดกรองอย่างเคร่งครัด **"นำเข้าเฉพาะหัวข้อที่ขึ้นต้นด้วย ''งาน' หรือ 'งาน' เท่านั้น" (Strict Work Header Filter Rule)**:
