...
> [!TIP]
> สำหรับผู้สอน (Trainer): สามารถใช้ปุ่ม **`รับ Order ใหม่ (INT)`** หรือ **`จำลอง 16 งาน (INT)`** ที่อยู่บนหน้ารายการงานทั้งหมด เพื่อจำลองการยิง Order ใหม่จากระบบ INT ข้ามมาทดสอบได้ทันที (Quick 8 งาน, Renovate 8 งาน)
