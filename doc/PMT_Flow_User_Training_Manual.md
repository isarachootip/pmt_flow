...
> [!TIP]
> สำหรับผู้สอน (Trainer): สามารถใช้ปุ่ม **`รับ Order ใหม่ (INT)`** หรือ **`นำเข้า 20 งาน (INT)`** ที่อยู่บนหน้ารายการงานทั้งหมด เพื่อจำลองการยิง Order ใหม่จากระบบ INT ข้ามมาทดสอบได้ทันที (Quick 10 งาน, Renovate 10 งาน)
