...
- แสดงผลในรูปแบบตารางรายการ (List View) ตามมาตรฐานระบบ พร้อมป้ายคะแนนสีสันชัดเจน:
  - **คะแนน QC (1.0 - 5.0 ⭐):** คำนวณจากค่าเฉลี่ย 5 ข้อคำถามมาตรฐาน (`ผ่าน Yes = 5 คะแนน`, `ไม่ผ่าน No = 1 คะแนน`)
  - **คะแนน CSAT (1.0 - 5.0 ⭐):** คะแนนความพึงพอใจลูกค้าที่ได้รับจากการโทรสัมภาษณ์ของ Contact Center
