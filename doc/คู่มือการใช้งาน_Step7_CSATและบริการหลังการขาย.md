...
1. **เข้าใจการทำงานของหน้าสรุปงานส่ง STK:** สามารถตรวจสอบสถิติ KPI ยอดงานสำเร็จ, ยอดตัดสต็อกวันนี้, มูลค่ารวม, และคะแนนคุณภาพเฉลี่ย
2. **การใช้งานตัวกรองและช่องค้นหาด่วน:** สามารถค้นหาและกรองตามช่วงเวลา (วันนี้, 7 วัน, 30 วัน, 60 วัน, 90 วัน, 180 วัน), กลุ่มงานบริการ, สาขา, และระดับคะแนน
3. **การเปิดดูข้อมูลเชิงลึก 4 แท็บใน Modal:** ดูสรุปผล QC/CSAT, คลังรูปถ่ายหน้างาน 5 ขั้นตอน, ไทม์ไลน์ 8 ขั้นตอน, และข้อมูล STK Integration Payload JSON
