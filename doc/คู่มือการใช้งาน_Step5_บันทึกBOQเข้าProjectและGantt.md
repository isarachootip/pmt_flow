...
2. ในแต่ละรายการ Task ให้ปรับแต่งข้อมูล:
   ...
   - **ระยะเวลา (Duration):** ระบบจะคำนวณจำนวนวันทำงานให้อัตโนมัติ โดยแสดงผลในบรรทัดเดียว คมชัด ไม่ต้องมีกรอบสีฉากหลัง (เช่น `1 วัน`, `3 วัน`) ตามมาตรฐานความคมชัด Pure Black Text
   - **ทีมช่างผู้รับผิดชอบ (ชื่อช่าง / ผู้ดูแล):**
     - **ช่องชื่อช่างแสดงเต็มความกว้าง (Full Width Input):** ดึงชื่อช่างจากระบบโครงการมาแสดงผลโดยตรง และขยายเต็มพื้นที่ตารางให้อ่านง่าย ชัดเจน ไม่โดนตัดทอน
     - **การพิมพ์ Key ระบุชื่อช่างได้อย่างอิสระ:** ช่องกรอกชื่อช่างเป็น Text Input ผู้ใช้สามารถพิมพ์ (Key in) ระบุชื่อช่างหรือทีมช่างคนใดก็ได้ตามต้องการ พร้อมรายการแนะนำ Autocomplete ผ่าน datalist
     - **ตัดปุ่ม INT ออกอย่างสมบูรณ์:** ไม่แสดงปุ่มเลือกช่างจาก INT ในตาราง เพื่อความกระชับ สะอาดตา และไม่เกะกะพื้นที่การทำงาน
     - **ดีไซน์กระชับ สะอาดตา (Minimal & Focused):** คอลัมน์ผู้รับผิดชอบแสดงผลอย่างลงตัว ไม่รกสายตา และแสดงชื่อช่างได้อย่างครบถ้วนไม่ถูกตัดทอน
...
> โดยในระบบ PMT ไฟล์ต้นฉบับ BOQ สามารถเรียกดูและดาวน์โหลดได้จากหน้าต่าง Unified Studio (Step 1/Step 3), หน้ารายการคำสั่งซื้อ (Job List) และหน้าต่าง Preview BOQ ส่วนในหน้าต่าง **"นำเข้า BOQ สู่ Project Tasks & แผนงาน Gantt"** จะเน้นดีไซน์แบบ Clean & Focused 100% ปลอดแบนเนอร์และปุ่มรบกวนสายตา เพื่อให้ผู้จัดการโครงการและทีมช่างโฟกัสกับการวางกำหนดการวันเริ่ม-สิ้นสุดของ Task และการซิงค์เข้า Gantt ได้รวดเร็วที่สุด
