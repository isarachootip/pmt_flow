...
2. ในแต่ละรายการ Task ให้ปรับแต่งข้อมูล:
   ...
   - **ทีมช่างผู้รับผิดชอบ (Key ชื่อช่าง / เลือกช่างจาก INT):**
     - **ระบบซ่อนปุ่ม INT อัตโนมัติเมื่อมีชื่อช่างจากระบบ:** หากในโครงการหรือ Task มีรายชื่อช่างที่ดึงมาจากระบบแล้ว (เช่น ช่างจากใบงาน/ระบบ INT) ระบบจะซ่อนปุ่ม `[เลือกช่างจาก INT]` ในแถวนั้นอัตโนมัติ เพื่อขยายช่องแสดงชื่อช่างให้อ่านง่ายเต็มความกว้าง
     - **ปุ่ม "เลือกช่างจาก INT" สำหรับงานที่ยังไม่ระบุช่าง:** สำหรับแถวงานที่ยังไม่มีรายชื่อช่าง ระบบจะแสดงปุ่ม `[เลือกช่างจาก INT]` ให้กดเปิดหน้าต่างเลือกรายชื่อช่างจากระบบ INT พร้อมคะแนนรีวิวและปุ่มยืนยันเลือกช่าง
     - **การพิมพ์ Key ระบุชื่อช่างได้อย่างอิสระ:** ช่องกรอกชื่อช่างเป็น Text Input ผู้ใช้สามารถพิมพ์ (Key in) ระบุชื่อช่างหรือทีมช่างคนใดก็ได้ตามต้องการ พร้อมรายการแนะนำ Autocomplete
