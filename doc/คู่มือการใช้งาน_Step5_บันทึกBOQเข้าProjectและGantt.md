...
## โมดูล: เจาะลึกหน้าจอ Step 2 (งานย่อยที่ 2) — แปลง BOQ เป็น Project (Labor-to-Task & Project Conversion Studio)
**รหัสหลักสูตร:** `TRN-PMT-STEP02B` (เดิม `TRN-PMT-STEP05`) | **ระบบ:** PMT Flow (Store Project Management Tool) | **เวอร์ชัน:** 3.0 (Pipeline Architecture) | **กลุ่มเป้าหมาย:** เจ้าหน้าที่วางแผนโครงการ (Project Planner), วิศวกรโครงการ, หัวหน้าทีมช่าง, ผู้จัดการโครงการ (PM) และวิทยากรผู้ฝึกอบรม (Trainer)

---

## 📌 บทสรุปและวัตถุประสงค์หลักสูตร (Course Overview & Objectives)

หน้าจอ **Step 2 (งานย่อยที่ 2: แปลง BOQ เป็น Project)** คือ **"ศูนย์บัญชาการแผนงานปฏิบัติการและการควบคุมเวลา (Operations & Scheduling Engine)"** ของระบบ PMT Flow ทำหน้าที่เปลี่ยนรายการค่าใช้จ่ายจากเอกสาร BOQ ให้กลายเป็น **"แผนปฏิบัติงานจริง (Project Tasks)"** ที่แสดงผลบนแผนภูมิแท่ง Gantt Timeline เต็มรูปแบบ โดยมีแกนหลัก 4 ประการ:
...
> [!IMPORTANT]
> **ขอบเขตและเงื่อนไขการเข้าสู่งานย่อยที่ 2 (Applicable Scope & Prerequisites):**  
> 1. **ต้องผ่าน Step 1 (BOQ) เรียบร้อยแล้วเท่านั้น:** โครงการที่จะส่งต่อหรือแปลงเข้าสู่ Project ได้ ต้องมีรายการวัสดุ/ค่าแรงใน BOQ อย่างน้อย 1 รายการ  
> 2. **เฉพาะงานโครงการปรับปรุง (Renovate Projects):** ส่วนงานย่อยที่ 2 นี้ถูกออกแบบมาสำหรับงานโครงการที่มีรายการ BOQ ที่ต้องแปลงเป็นแผนงานช่างใน Gantt Chart  
> 3. **งานบริการติดตั้งด่วน (Quick Services):** ระบบจะ **ข้ามการแปลง BOQ โดยอัตโนมัติ** ทันทีที่บันทึกชำระเงินและ Ticket ใน Step 2 งานย่อยที่ 1 เรียบร้อย โดยจะส่งตรงไปยัง **ตรวจรับรองคุณภาพ (QC Online)** ทันที เพื่อความรวดเร็วในการส่งมอบงาน
