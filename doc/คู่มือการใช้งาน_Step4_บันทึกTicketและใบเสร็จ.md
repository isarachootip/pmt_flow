...
## โมดูล: เจาะลึกหน้าจอ Step 2 (งานย่อยที่ 1) — บันทึก Ticket, แนบใบเสร็จ & สัญญา (Tickets, Payment Receipts & Contracts)
**รหัสหลักสูตร:** `TRN-PMT-STEP02A` (เดิม `TRN-PMT-STEP04`) | **ระบบ:** PMT Flow (Store Project Management Tool) | **เวอร์ชัน:** 3.0 (Pipeline Architecture) | **กลุ่มเป้าหมาย:** เจ้าหน้าที่ประสานงานช่าง (Dispatcher), เจ้าหน้าที่การเงิน/แคชเชียร์, เจ้าหน้าที่รับ Order, หัวหน้างาน และวิทยากรผู้ฝึกอบรม (Trainer)

---

## 📌 บทสรุปและวัตถุประสงค์หลักสูตร (Course Overview & Objectives)

หน้าจอ **Step 2 (งานย่อยที่ 1: แนบใบเสร็จ และสัญญา)** คือ **"ศูนย์กลางการออกใบสั่งงานและการยืนยันธุรกรรมการเงินและสัญญา (Work Order & Financial Gatekeeper)"** ของระบบ PMT Flow ทำหน้าที่รับช่วงต่องานจาก **Step 1 (Order Intake Studio)** เพื่อดำเนินกระบวนการสำคัญ 4 ประการ:
...
3. การตรวจสอบการชำระเงินของลูกค้า และการแนบหลักฐานสลิปโอนเงิน / ใบเสร็จรับเงิน (Payment Slip Attachment) และไฟล์สัญญาจ้าง
4. การตรวจสอบความพร้อมของสัญญาและเงื่อนไขการรับประกันก่อนปล่อยงานเข้าสู่ขั้นตอนการดำเนินงานติดตั้งจริง (งานย่อยที่ 2 แปลง BOQ เข้า Project หรือส่งทีมช่างลงพื้นที่)
...
2. **จัดการคิวงาน Single State Queue ใน Step 2 งานย่อยที่ 1 ได้อย่างถูกต้อง:** แยกแยะระหว่างงานที่ "รอออก Ticket/แนบสลิป" กับงานที่ "บันทึกเอกสารครบถ้วนแล้ว"
3. **เปิด Ticket และมอบหมายทีมช่างได้แม่นยำ:** สามารถระบุทีมช่าง วัน-เวลาเข้าปฏิบัติงาน และเชื่อมโยงกับการจองช่างผ่าน API
4. **แนบและตรวจสอบสลิปการโอนเงินและสัญญาจ้าง 100%:** บันทึกยอดเงิน วันที่-เวลาโอน เลขที่อ้างอิง และแนบไฟล์รูปภาพสลิปได้อย่างถูกต้อง
5. **ควบคุมการไหลของงานสู่งานย่อยที่ 2 (แปลง BOQ เป็น Project):** รู้วิธีย้ายงานเข้าสู่งานย่อยที่ 2 เพื่อแปลงค่าแรงลงสู่ Gantt Timeline อย่างไร้รอยต่อ

---

## 🧭 กายวิภาคของหน้าจอ Step 2 (งานย่อยที่ 1) (Screen Anatomy Breakdown)
