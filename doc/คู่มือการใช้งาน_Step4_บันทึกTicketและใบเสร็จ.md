...
5. **ควบคุมการแยกสายงาน (Routing Control):** ส่งต่องาน Quick Services เข้า QC Online (Step 5) หรือส่งต่องาน Renovate เข้าสู่ Step 3 อย่างแม่นยำ 100%
...
* **การแสดงผลวันเวลาที่เข้าสู่ State นี้ (State Entry Timestamp):** ในตารางคิวงาน คอลัมน์ **"ขั้นตอน (STAGE) / เข้า State"** จะแสดงวันและเวลาที่งานถูกส่งต่อเข้ามาสู่ Step 2 (`เข้า State: DD/MM/YYYY HH:mm น.`) อย่างชัดเจนใต้เกจความคืบหน้าและป้ายนับถอยหลัง SLA เพื่อให้เจ้าหน้าที่ตรวจสอบระยะเวลาคงเหลือของ SLA ได้อย่างโปร่งใส 100%
