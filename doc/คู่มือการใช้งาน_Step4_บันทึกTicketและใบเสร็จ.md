...
1. **โจทย์ข้อที่ 1:** เปิดหน้าต่างบันทึก Ticket ของงานด่วน `JOB202609001` กำหนดรหัส Ticket เป็น `TCK-AIR-001` และเลือกช่าง `Team A`
...
4. **โจทย์ข้อที่ 4:** กลับมาที่งาน Renovate `JOB202609003` บันทึก Ticket และสังเกตว่างาย้ายเข้าสู่ Step 5 เพื่อเตรียมแปลงค่าแรงเข้าแผนงาน Gantt
