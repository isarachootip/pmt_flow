...
* **แท็บ "คิวโครงการที่รอออก Ticket & แนบสลิป":** แสดงเฉพาะงานที่ต้องเปิด Ticket หรือยังขาดหลักฐานการชำระเงิน (Single State Queue)
* **แท็บ "คลัง Ticket, สลิปโอนเงิน และสัญญาจ้าง":** แสดงงานทั้งหมดที่มีการบันทึก Ticket และแนบเอกสารการเงินเรียบร้อยแล้ว เพื่อใช้ตรวจสอบย้อนหลังหรือดาวน์โหลดใบสั่งงาน
* **สวิตช์ Card View / List View:** เลือกระหว่างการดูแบบการ์ดสรุป หรือตารางแถวสำหรับตรวจสอบข้อมูลหลายรายการ
...
sequenceDiagram
    ...
    User->>UI: คลิกปุ่ม "ยืนยันย้ายไป Step 5"
    UI->>DB: ปรับปรุงสถานะงาน และส่งต่องานเข้าคิว Step 5
```
...
### ขั้นตอนที่ 3: การส่งต่องานไปยัง Step 5 (Project Conversion & Gantt)

เมื่อข้อมูล Ticket และหลักฐานการเงินได้รับการตรวจสอบเรียบร้อยแล้ว:
1. คลิกปุ่มสีม่วง **`ยืนยันย้ายไป Step 5`**
2. ระบบจะทำการตรวจสอบเงื่อนไข (Pre-flight Validation):
   - มีรหัส Ticket และกำหนดทีมช่างแล้วหรือไม่?
   - มียอดชำระเงินและแนบหลักฐานแล้วหรือไม่?
3. เมื่องานผ่านการตรวจสอบ สถานะจะเปลี่ยนเป็นพร้อมแปลงเข้าแผนงาน และงานจะย้ายเข้าสู่หน้าจอ **Step 5: บันทึก BOQ เข้า Project** ทันที
...
**สถานการณ์สมมติ:** "มีงานรับเข้า 2 งานใน Step 4 ได้แก่ งานด่วนติดตั้งแอร์ (Quick Service: `JOB202609001`) และงาน Renovate ครัว (`JOB202609003`) ให้ผู้เรียนดำเนินการดังนี้"

1. **โจทย์ข้อที่ 1:** เปิดหน้าต่างบันทึก Ticket ของงาน `JOB202609001` กำหนดรหัส Ticket เป็น `TCK-AIR-001` และเลือกช่าง `Team A`
2. **โจทย์ข้อที่ 2:** ทำการบันทึกการชำระเงินยอด 3,500 บาท โดยเลือกโอนเงินผ่านธนาคารกสิกรไทย และจำลองการแนบสลิป
3. **โจทย์ข้อที่ 3:** กดบันทึกข้อมูล และสังเกตว่ายอดเงินใน Card 3 (ยอดเงินชำระรวม) ปรับเพิ่มขึ้นทันทีหรือไม่
4. **โจทย์ข้อที่ 4:** กดย้ายงานไปยัง Step 5 เพื่อเตรียมจัดแผนงาน Gantt
