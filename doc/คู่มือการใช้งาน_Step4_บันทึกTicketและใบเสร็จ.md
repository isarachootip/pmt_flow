...
4. การปล่อยงานเข้าสู่ขั้นตอนถัดไปอย่างถูกต้อง:
   - **งานบริการด่วน (Quick Services):** ส่งตรงแบบ Fast-track ลัดเข้าสู่ **Step 5: ตรวจรับงาน QC (QC Online)** ทันที
   - **งานโครงการปรับปรุง (Renovate Projects):** ส่งต่อไปยัง **Step 3: เตรียมแผนงานและทีมช่าง (Project Conversion)** เพื่อแปลง BOQ เป็นแผนงาน Gantt ใน Step 4
...
* **การแสดงผลวันเวลาที่เข้าสู่ State นี้ (State Entry Timestamp):** ในตารางคิวงาน คอลัมน์ **"สถานะ SLA / เข้า State"** จะแสดงวันและเวลาที่งานถูกส่งต่อเข้ามาสู่ Step 2 (`เข้า State: DD/MM/YYYY HH:mm น.`) อย่างชัดเจนใต้ป้ายนับถอยหลัง SLA เพื่อให้เจ้าหน้าที่ตรวจสอบระยะเวลาคงเหลือของ SLA ได้อย่างโปร่งใส 100%
* **หน้าต่าง Pop up ดูข้อมูลงานที่เคยบันทึกไว้ (Task Quick View Modal):** เมื่อคลิกที่แถวงานหรือรหัสงาน (`VFIX-xxxxxx`) ในตาราง ระบบจะเปิดหน้าต่าง Pop up ขึ้นมาทันทีโดยไม่ต้องสลับหน้าจอ เพื่อให้เจ้าหน้าที่ตรวจสอบข้อมูลทั้งหมดที่เคยใส่ไว้แล้ว เช่น ข้อมูลลูกค้า, เบอร์โทร (มีปุ่มโทร/คัดลอก), ที่อยู่หน้างาน, สโคปงาน, ข้อกำหนดพิเศษ, รูปภาพสำรวจหน้างาน (Visit Plan Photos พร้อม Lightbox ดูรูปใหญ่), ยอดเงิน BOQ, สถานะ Ticket และไทม์ไลน์ พร้อมปุ่มลัดไปยังขั้นตอนถัดไป
