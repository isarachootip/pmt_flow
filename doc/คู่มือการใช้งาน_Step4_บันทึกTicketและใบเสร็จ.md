...
* **สวิตช์ Card View / List View และช่องค้นหา (Search):** เลือกระหว่างการดูแบบการ์ดสรุป หรือตารางแถว (List View) สำหรับตรวจสอบข้อมูลหลายรายการ โดยตารางแสดงรหัสงาน (Job ID), เลขที่อ้างอิง (Ref ID), เลขที่ Booking, **เลขที่ Ticket (Ticket No)** พร้อมช่องค้นหาที่รองรับการค้นหาด้วยเลขที่ Ticket, Booking, Ref ID, หรือชื่อลูกค้าได้ทันที
* **หน้าต่าง Pop up ดูข้อมูลงานที่เคยบันทึกไว้ (Task Quick View Modal):** เมื่อคลิกที่แถวงานหรือรหัสงานในตาราง ระบบจะเปิดหน้าต่าง Pop up ขึ้นมาทันที เพื่อให้เจ้าหน้าที่ตรวจสอบข้อมูลทั้งหมดที่เคยใส่ไว้แล้ว เช่น ข้อมูลลูกค้า, เบอร์โทร (มีปุ่มโทร/คัดลอก), ที่อยู่หน้างาน, สโคปงาน, ข้อกำหนดพิเศษ, รูปภาพสำรวจหน้างาน (Visit Plan Photos พร้อม Lightbox ดูรูปใหญ่), ยอดเงิน BOQ, และ **การแสดงรูปภาพพรีวิว (Image Preview) สลิปใบเสร็จรับเงินและสัญญาการทำงานอย่างชัดเจน พร้อมคลิกขยายใหญ่ (Lightbox Zoom)** และปุ่มลัดส่งต่องานไปยังขั้นตอนถัดไปได้อย่างรวดเร็ว
