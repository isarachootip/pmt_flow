...
* **หน้าต่าง Pop up ดูข้อมูลงานที่เคยบันทึกไว้ (Task Quick View Modal):** เมื่อคลิกที่แถวงานหรือรหัสงานในตาราง ระบบจะเปิดหน้าต่าง Pop up (`modal-job-preview-detail`) ขึ้นมาทันที เพื่อให้เจ้าหน้าที่ตรวจสอบข้อมูลสำคัญครบถ้วนในจุดเดียว:
  ...
  6. **การแสดงรูปภาพพรีวิว (Image Preview) สลิปใบเสร็จรับเงินและสัญญาการทำงานอย่างชัดเจน:** พร้อมคลิกขยายใหญ่ (Lightbox Zoom) ทั้งใน Task Quick View Modal และหน้าต่างบันทึก Ticket ใหม่ (`modal-create-ticket`) โดยในกล่องแนบไฟล์สลิปและสัญญาการทำงาน **ใช้ Icon รูปภาพ (`ph-image`) พร้อมข้อความกำกับชัดเจนว่า "ใส่รูปภาพตรงนี้" โดยไม่มีรูปแนะนำหรือปุ่มตัวอย่างหลอกตา** เพื่อความสะอาด ชัดเจน และรองรับการแนบภาพจริง พร้อมปุ่ม "ลบ / เปลี่ยนรูปภาพ" สะดวก รวดเร็ว อีกทั้งได้**ตัดส่วนไทม์ไลน์และประวัติการดำเนินงาน (Pipeline Progress History) ออกจาก Pop up** อย่างสมบูรณ์ เพื่อลดความซ้ำซ้อนและกระชับพื้นที่ให้เจ้าหน้าที่ตรวจสอบหลักฐานการเงินได้อย่างรวดเร็ว พร้อมปุ่มลัดส่งต่องานไปยังขั้นตอนถัดไป (Quick ไป QC Online / Renovate ไป Convert เข้า Project) ได้ทันที
...
2. **กรณีเป็นงานโครงการปรับปรุง (Renovate Projects):**
   - 🔨 **นำทางอัตโนมัติเข้าสู่ Step 3 (Convert เข้า Project) ทันที (Auto-Navigation to Project Conversion):** เมื่อบันทึก Ticket หรือแนบสลิป/หลักฐานการเงินสำเร็จ ระบบจะนำทางผู้ใช้งานตรงเข้าสู่หน้าจอ **"Step 3: เตรียมแผนงานและทีมช่าง (Convert เข้า Project)"** สำหรับงานนั้นทันที เพื่อให้สามารถจัดทีมช่าง คัดกรองค่าแรงจาก BOQ และสร้าง Task เข้าสู่แผนงาน Gantt ได้อย่างต่อเนื่อง ไร้รอยต่อ
   - 🧹 **ตัดออกจากคิวรอออก Ticket ทันที (Instant Queue Filter):** งานที่มีการแนบสลิปหรือบันทึก Ticket แล้ว จะถูกตัดออกจากรายการ "คิวโครงการที่รอออก Ticket & แนบสลิป" และตัวนับ Badge ทันที เพื่อไม่ให้มีรายการที่เสร็จสิ้นแล้วค้างอยู่ในคิว
   - 🚀 **ปุ่มลัดตารางรายการ (Action Button):** ในตารางคิวงาน สามารถคลิกปุ่ม **`Convert เข้า Project ➔`** เพื่อวิ่งตรงเข้าสู่หน้าจอ Project Conversion ของงานนั้นได้ทันทีในคลิกเดียว
...
> [!NOTE]
> **Q: เมื่อแนบสลิปหรือบันทึก Ticket สำเร็จแล้ว ทำไมระบบจึงสลับหน้าจอไปที่ "Convert เข้า Project" ทันที?**  
> **A:** เพื่อความคล่องตัวในการปฏิบัติงาน (Seamless Workflow) เจ้าหน้าที่ไม่ต้องเสียเวลากลับไปหาเมนูหรือคลิกหลายขั้นตอน ระบบจะนำทางพาไปยังหน้าจอ **Step 3: เตรียมแผนงานและทีมช่าง (Project Conversion)** พร้อมเลือกคำสั่งซื้อนั้นให้โดยอัตโนมัติ เพื่อดำเนินการจัดทีมช่างและแปลง BOQ เป็น Task บนแผนงาน Gantt ได้ทันที และงานดังกล่าวจะถูกคัดออกจากคิวรอออก Ticket ใน Step 2 ทันที ส่วนงานบริการด่วน (Quick Services) จะวิ่งตรงเข้าสู่หน้าจอ **ตรวจรับรองคุณภาพ QC Online** ทันที
