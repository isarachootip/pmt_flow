...
#### 4. แถบสรุปสถานะและความพร้อม และเงื่อนไขการส่งต่องาน (Live Status Bar & Step 3 Gating Rule)
- ด้านล่างของ Studio มี Status Indicator แบบ Realtime สะท้อนสถานะผ่าน/ยังไม่ผ่าน:
...
- **🚨 กฎเกณฑ์ความปลอดภัยบังคับ (Gating Rule):**
  - **สำหรับงาน Renovate:** หากคำสั่งซื้อยังไม่ผ่าน Step 3 (ยังไม่มีรายการ BOQ หรือมี 0 รายการ) **ปุ่มย้ายไป Step 5 จะถูกล็อกสถานะ (Disabled 100%)** กลายเป็นปุ่มสีเทา `🔒 รอผ่าน Step 3 (จัดทำ BOQ ก่อนไป Step 5)` ไม่สามารถคลิกข้ามขั้นตอนได้เด็ดขาด
  - เมื่อผู้ใช้เพิ่มรายการในแท็บ 3 หรือนำเข้าไฟล์ BOQ เรียบร้อย (มากกว่า 0 รายการ) ระบบจะ **ปลดล็อกอัตโนมัติ (Reactive Auto-Unlock)** เป็นปุ่มสีม่วง `🚀 อนุมัติ & แปลงเข้า Gantt (Step 5)` ทันที
- ปุ่มดำเนินการ:
  - **`💾 บันทึกข้อมูล (Save)`:** บันทึกข้อมูลร่างทั้งหมดลงในระบบ
  - **`🚀 ยืนยันข้อมูล & ส่งต่อไปขั้นตอนถัดไป`:**
    - หากเป็น **Quick Services** ➔ ส่งต่อไปยัง **Step 4 (บันทึก Ticket & ใบเสร็จ)** ทันที
    - หากเป็น **Renovate / MA** ➔ ต้องผ่าน Step 3 (BOQ) ก่อน จึงจะสามารถส่งต่อไปยัง **Step 5 (แปลง BOQ เข้า Gantt Timeline)** ได้
