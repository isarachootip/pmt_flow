...
graph TD
    ...
    Decision -->|งานบริการด่วน Quick Services| Res1["✅ ผลลัพธ์ (Result A):<br><b>สถานะเปลี่ยนเป็น 'ticket'</b><br>ส่งตรงเข้า Step 2 (Tickets & Receipts)<br>เพื่อเปิดใบสั่งงานช่างและแนบใบเสร็จ"]
...
1. **กรณีงานบริการด่วน (Quick Services - ติดตั้งอุปกรณ์เดี่ยว/แอร์/เครื่องทำน้ำอุ่น):**
   - **ผลลัพธ์ (Result):** งานจะเปลี่ยนสถานะเป็น **`ticket`** (ความคืบหน้า 50%) และส่งต่อไปยัง **Step 2: บันทึก Ticket & ใบเสร็จ** ทันที
   - **ประโยชน์:** เจ้าหน้าที่สามารถเปิด Work Order ให้ช่างหน้างานเข้าติดตั้ง พร้อมมีช่องให้ช่างแนบสลิป/ใบเสร็จค่าใช้จ่ายได้ทันที และส่งลัดเข้าตรวจ QC Online (Step 5) ต่อไป
...
### Q3: การสร้างงานใหม่ผ่านปุ่ม "รับ Order ใหม่ (INT)" มีข้อมูลเริ่มต้นอย่างไร?
> **คำตอบ:** เมื่อเจ้าหน้าที่กดปุ่ม **`[ + รับ Order ใหม่ (INT) ]`** ที่แถบเครื่องมือด้านบน:
