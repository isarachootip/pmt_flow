...
graph TD
    ...
    Decision -->|งานบริการด่วน Quick Services| Res1["✅ ผลลัพธ์ (Result A):<br><b>สถานะเปลี่ยนเป็น 'ticket'</b><br>ส่งตรงเข้า Step 4 (Tickets & Receipts)<br>เพื่อเปิดใบสั่งงานช่างและแนบใบเสร็จ"]
    Decision -->|งานโครงการ Renovate / MA| Res2["✅ ผลลัพธ์ (Result B):<br><b>สถานะเปลี่ยนเป็น 'boq_approved'</b><br>ส่งต่อเข้า Step 5 (Labor-to-Task & Gantt)<br>เพื่อแปลงค่าแรง/วัสดุเป็น Task แผนงาน Gantt"]
```
...
1. **กรณีงานบริการด่วน (Quick Services - ติดตั้งอุปกรณ์เดี่ยว/แอร์/เครื่องทำน้ำอุ่น):**
   - **ผลลัพธ์ (Result):** งานจะเปลี่ยนสถานะเป็น **`ticket`** (ความคืบหน้า 60%) และส่งต่อไปยัง **Step 4: บันทึก Ticket & ใบเสร็จ** ทันที
   - **ประโยชน์:** เจ้าหน้าที่สามารถเปิด Work Order ให้ช่างหน้างานเข้าติดตั้ง พร้อมมีช่องให้ช่างแนบสลิป/ใบเสร็จค่าใช้จ่ายได้ทันที

2. **กรณีงานโครงการปรับปรุง (Renovate) หรือสัญญาบำรุงรักษา (MA):**
   - **ผลลัพธ์ (Result):** งานจะเปลี่ยนสถานะเป็น **`boq_approved`** (ความคืบหน้า 50%) และส่งต่อไปยัง **Step 5: บันทึก BOQ เข้า Project** ทันที
   - **ประโยชน์:** นำรายการค่าแรงและวัสดุจาก BOQ ไปจับคู่แปลงเป็นงานย่อย (Labor-to-Task Conversion) และสร้างแท่งแผนงานบน **Gantt Chart Timeline** ได้ทันทีโดยไม่ต้องกรอกข้อมูลซ้ำ
...
1. 🟣 **Step 1: บันทึกงาน / รับ Order (One-Stop Studio):** คิวงานคำสั่งซื้อใหม่ พร้อมแถบ Task งานย่อย 3 ขั้นตอน:
   - 🔍 **สำรวจ (Survey):** ตรวจสอบข้อมูลสำรวจหน้างานและคลังรูปถ่ายจาก INT
   - 📐 **แนบแปลน (Design & CAD):** แนบไฟล์แบบแปลน แบบ 2D/3D และแบบติดตั้ง
   - 💰 **ใส่ BOQ (Pricing):** จัดทำรายการประมาณการราคาและรายการค่าแรง/พัสดุ
2. 🟢 **Step 2: บันทึก Ticket & ใบเสร็จ:** เปิดใบสั่งงาน (Work Ticket) และแนบสลิป/ใบเสร็จรับเงิน พร้อมแปลง BOQ เข้า Project (Tickets & Conversion)
