...
| Case ID | ขั้นตอนการทดสอบ (Test Steps) | ข้อมูลที่ใช้ทดสอบ (Test Data) | ผลลัพธ์ที่คาดหวัง (Expected Results) | ผลการตรวจ (Pass/Fail) |
| :--- | :--- | :--- | :--- | :---: |
| **TC-DLOG-01** | 1. เข้าเมนู **"แผนงาน Gantt เต็มรูป"** (`nav-gantt`)<br>2. สังเกตแถบงานใน Gantt Timeline<br>3. คลิกปุ่ม **"บันทึกช่าง"** ในแถวงาน เพื่อเปิดโมดอลบันทึกงานช่างประจำวัน (`modal-daily-work-log`) | Task ของโครงการ | เปิด Modal บันทึกงานช่างประจำวันขึ้นมาได้ถูกต้อง | [ ] Pass<br>[ ] Fail |
...
| **TC-STD-03** | **มาตรฐานธีมสว่างบริสุทธิ์ (Pure Light Theme Standard)**<br>ตรวจสอบความสม่ำเสมอของธีมสว่างทั่วทุกหน้าจอ | แสดงผลด้วย **ธีมสว่าง (Light Theme) 100%** ทั่วทั้งระบบ สีข้อความ กราฟ Chart.js และตารางคมชัดสูงสุด ไม่กลืนกับพื้นหลัง ปลดการสลับโหมดมืดออกถาวรเพื่อความเสถียรและป้องกันปัญหาหน้าจอค้าง | [ ] Pass<br>[ ] Fail |
